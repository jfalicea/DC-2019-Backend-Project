...
async function adminCreate({ first_name, last_name, email, user_role, emp_status, password }, user_id) {
    ...
    try {
        ...
        const newEmployee = await db.one(`
            ...
            insert into employees
                (first_name, last_name, email, user_role, emp_status, password, company_id)
            values ($1, $2, $3, $4, $5, $6, $7)

            returning id, first_name, last_name, email, user_role, emp_status

        `, [first_name, last_name, email, user_role, emp_status, hash, user_id]);
...
async function checkEmployee(req) {
    try{
        ...
        const correctPass = bcrypt.compareSync(req.body.password, query.password);
